...
class ClicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create click" do
    assert_difference('Click.count') do
      post clicks_url, params: { click: { click_timestamp: @click.click_timestamp, status: @click.status, uuid: @click.uuid } }
    end
  ...
  test "should update click" do
    patch click_url(@click), params: { click: { click_timestamp: @click.click_timestamp, status: @click.status, uuid: @click.uuid } }
